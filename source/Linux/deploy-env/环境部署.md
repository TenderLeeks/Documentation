...
$ GO_VERSION="1.17.3"  # 默认安装版本为：1.17.3
$ DIR="/opt"  # 安装目录，确保用户有DIR目录权限，默认安装目录为用户家目录

# 命令示例：sh golang_install.sh install ${NODE_VERSION} ${DIR}
# 安装
$ bash <(curl -s "https://raw.githubusercontent.com/TenderLeeks/Documentation/main/scripts/golang_install.sh") install

# 卸载
$ bash <(curl -s "https://raw.githubusercontent.com/TenderLeeks/Documentation/main/scripts/golang_install.sh") uninstall
